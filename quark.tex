...
\begin{acks}                            %% acks environment is optional
  ...
  thoughtful comments. First author has benefited from substantial
  discussions with Anmol Sahoo and Suresh Jagannathan. Anmol has also
  developed and maintained the OCaml-Scylla library, which is a key
  piece of infrastructure underlying \quark.
\end{acks}
