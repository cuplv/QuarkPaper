...
% be refactored to suit distributed execution. 
...
\C{merge} is a complete function, and thefore can be safely invoked to
...
%Sec.~\ref{sec:motivation} explains these insights in detail.
