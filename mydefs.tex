...
\newcommand{\condexp}[3]{{#1?\,#2:\,#3}}
\newcommand{\ite}[3]{\C{IF}\;#1\;\C{THEN}\;#2\;\C{ELSE}\;#3}
\newcommand{\lete}[3]{\C{LET}\;#1=#2\;\C{IN}\;#3}
\newcommand{\foreache}[2]{\texttt{FOREACH}\;#1\;\texttt{DO}\;#2}
\newcommand{\inserte}[1]{\texttt{INSERT}\;t\;#1}
\newcommand{\selecte}[1]{\texttt{SELECT}\;t\;#1}
\newcommand{\deletee}[1]{\texttt{DELETE}\;t\;#1}
\newcommand{\updatee}[2]{\texttt{UPDATE}\;t\;#1\;#2}
\newcommand{\rollback}[0]{\texttt{ROLLBACK}}
\newcommand{\mape}[2]{{\texttt{MAP}\;(#1)\;#2}}
\newcommand{\folde}[3]{{\texttt{FOLD}\;(#1)\;#2\;#3}}
\newcommand{\lambdae}[2]{\lambda #1.\,#2}
\newcommand{\Rmem}{R_{mem}}
\newcommand{\Rob}{R_{ob}}
\newcommand{\Robs}{R_{ob}}
\newcommand{\Roas}{R_{oa}}
\newcommand{\Rio}{R_{io}}
\newcommand{\Rans}{R_{ans}}
\newcommand{\Rfst}{R_{fst}}
\newcommand{\Rsnd}{R_{snd}}
\newcommand{\Rpair}{R_{pair}}
\newcommand{\Rk}{R_{k}}
\newcommand{\Rkv}{R_{kv}}
\newcommand{\Rto}{R_{to}}
...
\newcommand{\rmerge}{\blacklozenge}
\newcommand{\gammaord}{\gamma_{ord}}
