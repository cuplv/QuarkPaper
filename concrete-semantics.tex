...
is easy to address as the execution only needs version history
inasmuch as it is required to obtain the LCA versions for
\rulelabel{Merge}. Since LCA version vectors monotonically increase,
